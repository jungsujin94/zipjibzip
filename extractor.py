...
{{
  ...
  "card1": {{
    "tag": "HOOK",
    "headline": "스크롤 멈추는 30자 이내 문구. '이거 내 얘기잖아?' 느낌. 아래 유형 중 제품에 가장 어울리는 한 가지로 작성 (유형을 매번 다양하게 선택할 것):
    - [페인포인트 직격] 예: '하루 10시간 앉아 있는데 의자가 싸구려?'
    - [반전/놀람] 예: '10만원짜리 소파가 이 퀄리티라고?'
    - [공감 상황 묘사] 예: '손님 오기 전날 밤 거실 보면 한숨부터 나오죠'
    - [질문형 저격] 예: '침대 빼고 전부 바꾼다면 제일 먼저 뭐 사세요?'
    - [수치/팩트 후킹] 예: '5년 쓴 의자, 허리 디스크 비용이랑 바꾼 셈'
    - [before/after 암시] 예: '이 선반 두기 전엔 거실 사진 못 올렸어요'
    절대 금지: '분위기가 달라진다', '분위기를 바꿔준다' 같은 막연한 분위기 표현",
