...
{{
  ...
  "card3": {{
    ...
    "headline": "실제 구매자 후기",
    "reviews": [
      {{"rating": 5, "text": "리뷰 핵심 문구 요약 (40자 이내, 구매자 말투 그대로 살리기)"}},
      {{"rating": 5, "text": "리뷰 핵심 문구 요약 (40자 이내)"}},
      {{"rating": 5, "text": "리뷰 핵심 문구 요약 (40자 이내)"}},
      {{"rating": 4, "text": "리뷰 핵심 문구 요약 (40자 이내)"}},
      {{"rating": 4, "text": "리뷰 핵심 문구 요약 (40자 이내)"}}
    ],
...
1. 가격은 제품 정보에 있는 값을 그대로 사용 (절대 만들어내지 말 것)
   REVIEW 카드(card3): 제품 정보에 reviews 배열이 있으면 그 내용을 바탕으로 요약하고, 없으면 제품 특성에 맞게 실제 구매자가 남길 법한 후기 문구를 3개 창작할 것. 창작 시에도 rating은 4~5 사이로 현실적으로 설정.
2. STAT 수치는 독자가 "어, 이거 진짜야?" 하고 공유하고 싶을 만큼 insightful하고 believable해야 한다. 아래 원칙을 반드시 따를 것:
   ...
   - 수납/선반: 하루 평균 물건 찾는 시간 10분(생산성 연구), 정리된 공간 vs 어수선한 공간에서 집중 유지 시간 차이 2.1배(UCLA 연구), 시야에 물건이 많을수록 코르티솔 수치 평균 17% 상승
